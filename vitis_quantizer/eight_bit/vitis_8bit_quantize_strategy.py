...
from vitis_quantizer.eight_bit import vitis_8bit_transforms_pipeline
...
Vitis8BitOptimizeTransformsPipeline = (
    vitis_8bit_transforms_pipeline.Vitis8BitOptimizeTransformsPipeline
)
Vitis8BitQuantizeTransformsPipeline = (
    vitis_8bit_transforms_pipeline.Vitis8BitQuantizeTransformsPipeline
)
logger = common_utils.VAILogger

# vitis 8bit quantize strategy config
dirname = os.path.dirname(__file__)
vitis_8bit_qs_config = os.path.join(dirname, "vitis_8bit_quantize_strategy.json")
